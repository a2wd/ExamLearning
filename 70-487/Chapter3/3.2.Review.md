...
* 1.C The InstanceContextMode PerCall setting causes a new instance of a service for each request.
* 2.B/C/D There are many options for hosting WCF services, from IIS to console apps.
* 3.A/B/C for a service to be discoverable, it needs to have a discovery endpoint.