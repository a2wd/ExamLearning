...
* 1.A/B/D Azure provides various methods of logging, but items will not be stored locally after the appliaction is stopped.
* 2.A/B/E to enable intellitrace, you must set it up on deploy and you can view the logs from visual studio
* 3.C Performance counters for an app are configured in the Diagnostics.wadcfg file